...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800">
  ...
  <g transform="translate(300,200)">
    ...
    <rect x="28" y="88" width="544" height="364" rx="18" fill="#f8fafc" stroke="#e2e8f0"/>

    <g transform="translate(300,160)" fill="none" stroke="#475569" stroke-width="16" stroke-linecap="round" stroke-linejoin="round">
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800">
  ...
  <g transform="translate(300,200)">
    ...
    <rect x="28" y="88" width="544" height="364" rx="18" fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.10)"/>

    <g transform="translate(300,160)" fill="none" stroke="rgba(255,255,255,0.78)" stroke-width="16" stroke-linecap="round" stroke-linejoin="round">
      <path d="M-120 36 L0 -36 L120 36 L0 108 Z"/>
      <path d="M-120 36 L-120 176 L0 248 L0 108"/>
      <path d="M120 36 L120 176 L0 248"/>
    </g>
