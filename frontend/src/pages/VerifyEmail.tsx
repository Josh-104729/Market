        ...
        <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 text-center">
          {status === 'loading' && (
            <>
              ...
              <h2 className="text-2xl font-bold text-gray-100 mb-2">Verifying Your Email</h2>
          ...
          {status === 'success' && (
            <>
              ...
              <h2 className="text-2xl font-bold text-gray-100 mb-2">Email Verified!</h2>
          ...
          {status === 'error' && (
            <>
              ...
              <h2 className="text-2xl font-bold text-gray-100 mb-2">Verification Failed</h2>
              <p className="text-gray-400 mb-6">{message}</p>
              <button
